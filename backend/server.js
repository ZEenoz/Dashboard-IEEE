...
app.use((req, res, next) => {
    ...
    res.header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept, ngrok-skip-browser-warning, Cache-Control, Pragma, Authorization, x-api-key");
